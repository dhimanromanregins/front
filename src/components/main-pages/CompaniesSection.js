          ...
          <div className="client-grid">
            <div className="columns is-multiline is-mobile">
              <div className="column is-half-mobile is-one-quarter-tablet">
                <figure className="image is-2x1"><img className="client-logo" src="https://www.ameotech.com/images/ameotech-logo.png" /></figure>
              </div>
              <div className="column is-half-mobile is-one-quarter-tablet">
                <figure className="image is-2x1"><img className="client-logo" src="https://www.zestgeek.com/assets/images/logo.png" /></figure>
              </div>
              <div className="column is-half-mobile is-one-quarter-tablet">
                <figure className="image is-2x1"><img className="client-logo" src="https://siancesoftware.com/frontend/assets/Images/sia%E1%B9%87ce.png" /></figure>
              </div>
            </div>
          </div>
        </div>
