          ...
          <div className="content">
            <div className="columns is-centered">
              ...
              <span class="fa-stack fa-2x">
                  ...
                  <i class="fas fa-server fa-stack-1x has-text-dark"></i>
                </span>
                <h1 className="title is-size-4 is-spaced">Backend Developer</h1>
                <p>
                  I appreciate well-organized data structures, streamlined code
                  architecture, and meticulous data processing.
                </p>
                <p className="list-title has-text-primary has-text-weight-normal">
                  Frameworks I enjoy woeking on:
                </p>
                <p>Django Rest Framework, FastApi, RestApi, Scrapy, Selenium</p>
                <p className="list-title has-text-primary has-text-weight-normal">
                  Development Tools:
                </p>
                <ul>
              ...
              <div className="column">
                ...
                <i class="fas fa-circle fa-stack-2x has-text-success"></i>
                  <i class="fas fa-globe fa-stack-1x has-text-dark"></i>
                </span>
              ...
              <div className="column">
                <span className="fa-stack fa-2x">
                  ...
                  <i class="fas fa-chalkboard-teacher fa-stack-1x has-text-dark" aria-hidden="true"></i>
                </span>
